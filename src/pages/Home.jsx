...
import PTE from "../assets/images/suad-kamardeen-ItFTJoh1A8c-unsplash.jpg";
                ...
                <div className="second-nav-container d-none d-md-block">
                    <nav className=" navbar-expand-xl second-nav d-none d-xl-block">
                        <div className="container-fluid">
                            ...
                            >
                                <ul className="navbar-nav ms-3 mb-lg-0 align-items-center mt-3">
                                ...
                                <div className="brand-icon ms-auto d-none d-xl-flex mt-3">
                                    <Link to="/">
                    ...
                    <div className="header-title mt-4 container d-flex flex-column">
                        ...
                        <p className="head-p2 d-none d-lg-block">
                            ما مردم را <br/> با یکدیگر <span id="united">متحد می کنیم. </span>
                        </p>
                        <p className="head-p3 d-none d-lg-block mt-2">
                            مفهوم یک شرکت مشاوره مدریریت در نیویورک است<br/> که متخصص در ساخت مدل
                            سازی اطلاعات است.
                        </p>
                        <a href="#">
